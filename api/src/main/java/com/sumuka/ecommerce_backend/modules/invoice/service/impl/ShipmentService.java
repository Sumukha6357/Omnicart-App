...
import com.sumuka.ecommerce_backend.modules.common.exception.ResourceNotFoundException;
...
public class ShipmentService {
    ...
    public List<Shipment> getShipmentsBySeller(UUID sellerId) {
        return shipmentRepository.findAll().stream()
                ...
                .filter(shipment -> shipment.getOrder().getItems().stream().anyMatch(item -> item.getProduct() != null
