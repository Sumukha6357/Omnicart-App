package com.sumuka.ecommerce_backend.modules.notification.service.impl;
...
import com.sumuka.ecommerce_backend.modules.notification.repository.MailLogRepository;
...
public class MailServiceImpl implements MailService {
    ...
    @Override
    @Async("taskExecutor")
    public CompletableFuture<MailResponseDTO> sendMail(MailRequestDTO req) {
        ...
        try {
            ...
            return CompletableFuture.completedFuture(new MailResponseDTO(true, "📩 Email sent successfully."));

        } catch (MessagingException | RuntimeException e) {
            log.setSuccess(false);
            log.setErrorMessage(e.getMessage());
            mailLogRepo.save(log);
            return CompletableFuture.completedFuture(new MailResponseDTO(false, "❌ Failed: " + e.getMessage()));
        }
    }
