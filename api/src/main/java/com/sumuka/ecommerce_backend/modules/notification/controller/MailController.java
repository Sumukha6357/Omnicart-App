package com.sumuka.ecommerce_backend.modules.notification.controller;
...
public class MailController {
    ...
    @PostMapping("/send")
    public java.util.concurrent.CompletableFuture<MailResponseDTO> sendMail(@RequestBody MailRequestDTO request) {
